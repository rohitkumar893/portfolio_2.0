  ...
  return (
    <div className='hero h-full w-full text-white flex bg-gray-900 flex-col gap-[30px] justify-center items-center pl-[32px] pr-[32px] sm:pl-[140px] sm:pr-[140px]' id="home">
      <div className="div mt-[22px]">
          <p className='summary text-center text-[45px] sm:text-[52px] md:text-[70px] select-none font-medium leading-tight'>I turn ideas into <br></br> <span className='fancytext whitespace-nowrap'>working solutions</span> through code</p>
        </div>
