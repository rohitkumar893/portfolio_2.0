...
const Hero:React.FC = () => {
  return (
    <section className='hero h-full w-full text-white flex bg-gradient-to-r from-gray-800 to-black flex-col gap-[42px] md:gap-[28px] justify-center items-center pl-[32px] pr-[32px] sm:pl-[140px] sm:pr-[140px] border-b-1 border-white' id="home">
