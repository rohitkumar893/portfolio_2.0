...
const Certificates: React.FC = () => {
  return (
  <section className='certifications flex flex-col justify-center items-center gap-[90px] py-[150px] px-[40px] sm:px-[120px] bg-gradient-to-r from-gray-600 to-gray-900'
      id="certifications"
    >
