    ...
    <div className='certifications flex flex-col  justify-center items-center gap-[90px] p-[150px] bg-gray-800 px-[40px] sm:px-[120px]' id="certifications">
      ...
      <div className='flex flex-col flex-wrap justify-evenly sm:gap-[70px]'>
        ...
        <a href='https://www.coursera.org/account/accomplishments/verify/LFQ94ZUI1Q7K'>
          <div className='mt-[50px] md:ml-[-350px] mb-[40px] rotate-0 sm:rotate-357 h-[260px] w-[340px] sm:h-[300px] sm:w-[400px] flex items-center justify-center bg-gray-100 rounded-md hover:bg-blue-300 overflow-hidden'>
        ...
        <a href='https://www.coursera.org/account/accomplishments/verify/2FGSN01B5TS3'>
          <div className='mt-[50px] md:mr-[-350px] mb-[40px] rotate-0 sm:rotate-3 h-[260px] w-[340px] sm:h-[300px] sm:w-[400px] flex items-center justify-center bg-gray-100 rounded-md hover:bg-blue-300 overflow-hidden'>
