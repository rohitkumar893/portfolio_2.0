  ...
  return (
    <div className='projectscont bg-gray-800 text-white flex justify-center items-center h-auto p-[150px] px-[40px] sm:px-[120px] flex-col w-full' id="projects">
        ...
        <div className='projects flex flex-col flex-wrap justify-evenly gap-[0px] sm:gap-[70px] text-black mt-[50px]'>
            ...
            {/* <a href="https://github.com/rohitkumar893/buildmyres/"><div className='mt-[50px] md:ml-[-350px] mb-[40px] rotate-0 sm:rotate-357 sm:hover:rotate-360 transition h-[290px] w-[340px] sm:h-[330px] sm:w-[400px] flex flex-col justify-between items-center bg-gray-100 rounded-md hover:bg-blue-200'>
              <img src="resbuilder.png" className='w-full shadow-sm'></img>
              <h1 className='text-[20px] p-[18px]'>Resume Builder</h1>
              <p className='mb-[20px] mt-[-8px] text-gray-600 text-[16px] sm:text-[18px]'>'Platform for building resumes'</p>
            </div></a> */}
        </div>
    </div>
  )
