...
const Projects: React.FC = () => {
  return (
    <section
      className='projectscont bg-gradient-to-r from-gray-900 to-gray-800 text-white flex justify-center items-center h-auto py-[150px] px-[40px] sm:px-[120px] flex-col w-[full]' id="projects">
