...
const Contact:React.FC = () => {
  return (
    <section className = "flex flex-col bg-gradient-to-r from-gray-900 to-gray-600 justify-center items-center gap-[20px] p-[150px] px-[40px] sm:px-[120px]" id="contact">
