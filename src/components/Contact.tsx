...
const Contact:React.FC = () => {
  return (
    <section className = "flex flex-col bg-gradient-to-r from-gray-800 to-gray-900 justify-center items-center gap-[20px] p-[150px] px-[40px] sm:px-[120px]" id="contact">
