...
const Navbar:React.FC = () => {
  ...
  return (
    <div className="navbar fixed border-b border-gray-400 select-none top-0 left-0 h-16 bg-gray-900/75 backdrop-blur-md sm:h-22 w-full flex justify-between px-[20px] md:px-[25px] md:justify-around items-center text-lg font-medium text-white z-3">
